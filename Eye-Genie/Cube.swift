...
class Cube: Node {
    ...
    init(device: MTLDevice, commandQ: MTLCommandQueue){
        ...
        let V = Vertex(x:  1.0, y:  -1.0, z:  -1.0, r:  1.0, g:  0.0, b:  0.0, a:  1.0, s: 0.75, t: 0.50)
        let W = Vertex(x: -1.0, y:  -1.0, z:  -1.0, r:  1.0, g:  0.0, b:  0.0, a:  1.0, s: 1.00, t: 0.50)
        let X = Vertex(x: -1.0, y:   1.0, z:  -1.0, r:  1.1, g:  0.0, b:  0.0, a:  1.0, s: 1.00, t: 0.25)
        ...
        //3
        let texture = MetalTexture(resourceName: "carbon", ext: "jpg", mipmaped: true)
